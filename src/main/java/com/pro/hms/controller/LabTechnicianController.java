...
public class LabTechnicianController {
	...
	private DoctorService lttorService;
	...
	public LabTechnicianController(LabTechnicianService labTechnicianService,DoctorService lttorService,TestService testService,PatientService patientService) {
		super();
		this.labTechnicianService = labTechnicianService;
		this.lttorService=lttorService;
	...
	public String LTDashBoard(Model model)
	{
		...
		model.addAttribute("lttors",lttorService.getAllDoctors());
        LocalDate maxDate =  LocalDate.now();
        model.addAttribute("maxDate",maxDate);
		return "Labtechnician-DashBoard";
	}
	@PostMapping("/filterListofTests")
	public String filterListofTests(@RequestParam String date,@RequestParam String lttor,@RequestParam String status,Model model)
	{
		...
		if(!lttor.equals("Select Doctor"))
			SelectedDoctor=lttor;
	...
	@PostMapping("/uploadReportbyLabTechnician/{testId}/{patId}")
	public String uploadReportsByLabtechnician(@PathVariable Long testId,@PathVariable Long patId,@RequestParam MultipartFile[] report,Model model)
	{
